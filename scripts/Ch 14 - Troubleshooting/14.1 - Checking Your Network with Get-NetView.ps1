...
Install-Module -Name Get-NetView -Force

# 3. Checking installed verson of Get-NetView
Get-Module -Name Get-NetView
...
# 7. Viewing the output folder
$OFF = Get-ChildItem $OF
$OFF

# 8. Viewing the output folder contents
